...
@section('content')
    ...
    <div class="home-book container">
        ...
        <div class="home-book__container" if="#rezerva-loc">
            ...
            <form action="<?php echo route('payment') ?>" method="get" class="mt-24 ">
                <div class="input-group">
                    <label for="name" class="input-group__label">
                        Nume complet
                    </label>
                    <input type="text" name="name" id="name" class="input-group__input" value="Etcu Stefan Marian">
                ...
                <div class="input-group mt-16">
                    ...
                    <input type="text" name="phone_number" id="phone_number" class="input-group__input" value="0735335333">
                    <!-- <div class="input-group__error mt-8">
                        test
                    </div> -->
                </div>
                ...
                <div class="input-group mt-16">
                    ...
                    <input type="text" name="stand" id="stand" class="input-group__input" value="c4">
                </div>
                <div class="input-group mt-16">
                    <label for="count_fisher" class="input-group__label">
                        Pescari
                    </label>
                        <input style="margin:6px;" type="number" name="count_fishers" id="count_fishers" class="align-items-baseline" max="16" min="1" value="1">
                </div>
                <div class="input-group mt-16">
                    <label for="from_date" class="input-group__label">
                        From date
                    </label>
                    <input type="text" name="from_date" id="from_date" class="input-group__input" value="22.08.2022">
                </div>
                <div class="input-group mt-16">
                    <label for="to_date" class="input-group__label">
                        To date
                    </label>
                    <input type="text" name="to_date" id="to_date" class="input-group__input" value="23.08.2022">
                </div>
